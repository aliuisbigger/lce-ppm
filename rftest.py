...
t1=time.time()
param = {
    'n_estimators': range(30, 200, 10),'max_depth':range(4, 11, 1)
}
...
#10.csv  最好参数：{'max_depth': 10, 'n_estimators': 160}，最好分数0.8444545360023975
#20.csv     {'max_depth': 10, 'n_estimators': 60}，最好分数0.7085829591131562
#30.csv     最好参数：{'max_depth': 9, 'n_estimators': 80}，最好分数0.8651376416843627